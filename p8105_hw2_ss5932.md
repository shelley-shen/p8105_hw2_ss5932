...
**Part 1** Read and clean data in pols-month csv file. I will first
separate the date variable into year, month, and day and then remove the
day variable. Then I will create a president variable and remove the
