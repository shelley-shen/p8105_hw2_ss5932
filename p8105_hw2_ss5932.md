...
above and using pivot\_longer to merge the month variables into one
columnn and their respective values into a separate percentage
unemployed column. I will also convert year and month into factor
variables to ensure that it can merge with the other datasets later.
...
indicating that no measurements were obtained or available of the
closing values of the S\&P prior to January 1950. There are a total of
787 observations in the snp dataset which ranges from 1950 until 2015.
...
available of unemployment until January 1948. There are a total of 816
observations in the unemployment dataset which ranges from 1948 until
2015.
